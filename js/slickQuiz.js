...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Responder!',
                nextQuestionText: 'Pr&oacute;ximo &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Questão %current de %total',
                preventUnansweredText: 'Você precisa selecionar uma opção.',
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                $quizHeader.hide().prepend($('<div class="h4 quizDescription">' + quizValues.info.main + '</div>')).fadeIn(1000, kN(key,2));
                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var answerContent = $('<li class="list-group-item list-group-item-primary"></li>')
                                    .append(input)
                                    .append(optionLabel);
            ...
            checkAnswer: function(checkButton, options) {
                ...
                if (correctResponse) {
                    if(selectedAnswers.length > 0){
                        finalScore += selectedAnswers[0]+1;
                        console.log("partial score is: " + finalScore);
                    }
            ...
            completeQuiz: function(options) {
                ...
                */
                ...
                var score        = $(_element + ' ' + _correct).length,
                    displayScore = parseFloat(finalScore);
                ...
                if (plugin.config.disableScore) {
                    ...
                    $(_quizScore + ' span').html(plugin.config.scoreTemplateText
                        .replace('%score', displayScore).replace('%total', questionCount*5));
                }
                ...
                if (plugin.config.disableRanking) {
                    ...
                    var levels    = [
                        ...
                        levelRank = plugin.method.calculateLevel2(score),
                        levelText = $.isNumeric(levelRank) ? levels[levelRank] : '';

                        console.log("ranking: " + levelRank);
            ...
            calculateLevel2: function(correctAnswers) {
                var percent = (parseFloat(parseFloat(finalScore)*1.0 / (parseFloat(questionCount)*5.0))).toFixed(2),
                    level   = null;
                ...
                console.log("final Score: " + finalScore + " questionCount*5: " + questionCount*5 + " percent:" + percent + " level: " + level);
